...
export const FACTORY_ADDRESS_MAP: Record<number, string> = {
  ...
  [ChainId.FON_CHAIN]: FACTORY_ADDRESS_FON,
...
export const INIT_CODE_HASH_MAP: Record<number, string> = {
  ...
  [ChainId.FON_CHAIN]: INIT_CODE_HASH_FON,
...
export const WETH9 = {
  ...
  [ChainId.FON_CHAIN]: new ERC20Token(
    ChainId.FON_CHAIN,
...
export const WNATIVE: Record<number, ERC20Token> = {
  ...
  [ChainId.FON_CHAIN]: WETH9[ChainId.FON_CHAIN],
...
> = {
  [ChainId.FON_CHAIN]: {name: 'FON', symbol: 'FON', decimals: 18},
